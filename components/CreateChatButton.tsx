...
//     // ✅ Count chats using FIREBASE UID
//     const noOfChats = (
//       await getDocs(chatMembersCollectionGroupRef(uid))
//     ).docs.length;
...
//         description:
//           "You've exceeded the limit of chats for the FREE plan. Please upgrade to PRO.",
//         variant: "destructive",
//         action: (
//           <ToastAction
//             altText="Upgrade"
...
//     // ✅ Write using FIREBASE UID
//     await setDoc(addChatRef(chatId, uid), {
//       userId: uid,
...
//       })
//       .catch((error) => {
//         console.error("some error in createchatbutton "+error);
//         toast({
//           title: "Error",
